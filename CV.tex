...
%Permanent Address \quad \quad \, \T& 120 Grange Drive \\
%& Swindon\\
%& Wiltshire\\
%& United Kingdom\\
%& SN3 4LD\\
...
%\begin{tabular}{ll}
% July--September 2009 \quad \, \T & Summer Research Studentship, funded by Trinity College, University \\
% & of Cambridge. Working with Professor Tim Gowers.\\
% & Topic: \emph{Does an Explicitly Definable Banach Space contain $c_0$ or $\ell_p$?}. \\
% July--August 2008 \T & Vacation Student, Data Connection, 100 Church Street, Enfield, UK. \\
% & Testing and debugging issues arising from multi-threading in the file \\
% & daemon component of the ``Session Border Controller''. \\
%\end{tabular}
